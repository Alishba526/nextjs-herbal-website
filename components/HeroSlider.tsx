...
const SLIDES = [
  { img: "/assets/banner1.png", eyebrow: "100% Organic • Herbal Excellence", title: "Nature's Purest\nHerbal Secrets", desc: "Discover the power of authentic botanical extracts for your wellness journey." },
