...
function ShopContent() {
  ...
  const filtered = useMemo(() => {
    ...
    return list;
  }, [products, q, category, sort, price, minRating]);

  if (!mounted) {
    return <div className="max-w-7xl mx-auto px-4 py-12 text-center">Loading shop...</div>;
  }
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-12">
      <h1 className="text-4xl font-bold font-serif mb-2">Organic Herbal Shop</h1>
      <p className="text-muted-foreground mb-8">Browse {filtered.length} premium natural herbal products available{category && ` in our ${category} collection`}. We offer the best herbal hair and skin care solutions.</p>
