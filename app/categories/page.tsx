...
export default function CategoriesPage() {
  ...
  if (!mounted) {
    return <div className="max-w-7xl mx-auto px-4 py-12 text-center">Loading categories...</div>;
  }
          ...
          return (
            <Link key={cat.name} href={`/shop?category=${cat.name}`}
              ...
              <div className="aspect-[4/3] overflow-hidden bg-secondary p-3">
                <Image src={cat.image} alt={cat.name} width={300} height={225} className="w-full h-full object-contain group-hover:scale-105 transition-transform duration-500" />
              </div>
